...
namespace Nummite.Shapes
{
	class RoundedBox : Box
	{
		...
		public readonly static new IPersistableHelper Helper = new BoxHelper<RoundedBox>(Description, Resources.RoundedBox);

		public override void SvgSave(XmlWriter writer)
		{
			Svg.WriteRoundedRectangle(writer, Location, Size, BackgroundColor, BorderPen, ROUNDNESS);
